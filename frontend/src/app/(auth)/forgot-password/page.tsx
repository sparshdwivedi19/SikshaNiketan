        ...
        {submitted ? (
          <div className="text-center">
            ...
            <p className="text-foreground-secondary mb-6">
              If an account with <strong className="text-foreground-primary">{email}</strong> exists, we have sent you a password reset link.
            </p>
            <Link href="/login">
          ...
          <>
            <div className="mb-8">
              <Link href="/login" className="flex items-center gap-2 text-sm text-foreground-secondary hover:text-brand-700 transition-colors mb-6">
