  ...
  return (
    <div className="w-full text-white">
      {submitted ? (
        ...
        <>
          <div className="mb-6">
            <Link href="/login" className="flex items-center gap-2 text-xs font-semibold text-slate-400 hover:text-white transition-colors mb-4">
              <ArrowLeft size={16} /> Back to Sign In
            </Link>
            <h2 className="text-3xl font-black font-heading text-white mb-2">Forgot Password?</h2>
            <p className="text-slate-400 text-sm font-medium">Enter your registered email address to receive a recovery link.</p>
          </div>
          ...
          <p className="mt-6 pt-5 border-t border-white/10 text-center text-sm text-slate-400 font-medium">
