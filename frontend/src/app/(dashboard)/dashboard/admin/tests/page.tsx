  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-foreground-secondary">Manage quizzes and tests for all courses.</p>
      </div>
        ...
        {courses.map((course) => (
          <Card key={course._id} className="p-5 flex flex-col gap-4">
            <div>
              ...
              <p className="text-sm text-foreground-secondary">By {course.instructor?.name || 'Unknown'}</p>
            </div>
            
            <div className="mt-auto">
              <Link href={`/dashboard/admin/tests/${course._id}`}>
